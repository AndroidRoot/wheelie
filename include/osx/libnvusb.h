...
struct nvDevice{
	...
	uint32_t nvRecSequence;
        IOUSBDeviceInterface ** deviceinterface;    /* interface to device, NULL = no interface */
	IOUSBInterfaceInterface ** interface; // Arg. OSX
...
int nvusb_get_chipuid(nvDevice_t nvdev);
